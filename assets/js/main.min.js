...
pigeonCounterEl.style.cssText =
  'position:fixed; top:70px; left:12px; z-index:15; display:none; ' +
...
document.body.appendChild(pigeonCounterEl);

function bumpPigeonCounter() {
  pigeonSpawnCount++;
  if (pigeonSpawnCount >= 100) {
    pigeonCounterEl.textContent = pigeonSpawnCount + ' pigeons spawned';
    pigeonCounterEl.style.display = 'block';
  }
}
